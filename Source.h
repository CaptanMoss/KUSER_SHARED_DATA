...
#define KUSER_SHARED_DATA_VA 0x7FFE0000 //read-only address for user-mode
static struct _KUSER_SHARED_DATA* KUSER_SHARED_DATA = KUSER_SHARED_DATA_VA;
...
*/
//0x720 bytes (sizeof) Windows 10 2009 20H2 (October 2020 Update) x86
...
Reference: 
https://www.vergiliusproject.com/kernels/x86/Windows%2010/2104%2021H1%20(May%202021%20Update)/_KUSER_SHARED_DATA
https://docs.microsoft.com/en-us/windows/win32/api/winnt/ns-winnt-large_integer-r1
https://github.com/PhoenicisOrg/winecx/blob/master/dlls/ntdll/thread.c#L276

kuser adresine offsetleri direk ekleyebilirsin yada structure adress atayıp çağırabilirsin, ikinci yöntem daha kolay
*/